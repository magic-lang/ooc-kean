...
FloatEuclidTransform: cover {
	...
	init: func@ ~default { this init(FloatSize3D new(), FloatRotation3D identity, 1.0f) }
	init: func@ ~translationAndRotation (translation: FloatSize3D, rotation: FloatRotation3D) { this init(translation, rotation, 1.0f) }
	...
	init: func@ ~fromTransform (transform: FloatTransform2D) {
		...
		this init(FloatSize3D new(transform g, transform h, 0.0f), FloatRotation3D createRotationZ(rotationZ), scaling)
	}
