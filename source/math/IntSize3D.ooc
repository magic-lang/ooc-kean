...
IntSize3D: cover {
	...
	fillEven: static func (other: This) -> This { This new(other width + (Int odd(other width) ? 1 : 0), other height + (Int odd(other height) ? 1 : 0), other depth + (Int odd(other depth) ? 1 : 0)) }
