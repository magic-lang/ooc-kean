...
glAttachShader: extern func (program, shader: UInt)
glBindAttribLocation: extern func (program: UInt, index: UInt, name: Char*)
glBindBuffer: extern func (target, buffer: UInt)
glBindFramebuffer: extern func (target, framebuffer: UInt)
glBindRenderbuffer: extern func (target, renderbuffer: UInt)
glBindTexture: extern func (target, texture: UInt)
glBlendColor: extern func (red, green, blue, alpha: Float)
glBlendEquation: extern func (mode: UInt)
glBlendEquationSeparate: extern func (modeRGB, modeAlpha: UInt)
...
glColorMask: extern func (red, green, blue, alpha: UInt)
...
glDepthRangef: extern func (n, f: Float)
glDetachShader: extern func (program, shader: UInt)
...
glFlush: extern func
glFramebufferRenderbuffer: extern func (target, attachment, renderbuffertarget, renderbuffer: UInt)
glFramebufferTexture2D: extern func (target, attachment, textarget, texture, level: Int)
...
glHint: extern func (target, mode: UInt)
...
glPolygonOffset: extern func (factor, units: Float)
...
glStencilMaskSeparate: extern func (face, mask: UInt)
glStencilOp: extern func (fail, zfail, zpass: UInt)
glStencilOpSeparate: extern func (face, fail, zfail, zpass: UInt)
...
glUniform1i: extern func (location, x: Int)
...
glUniform2i: extern func (location, x, y: Int)
...
glUniform3i: extern func (location, x, y, z: Int)
...
glUniform4i: extern func (location, x, y, z, w: Int)
...
glViewport: extern func (x, y, width, height: Int)
...
glBeginQuery: extern func (target, id: UInt)
...
glVertexAttribI4ui: extern func (index, x, y, z, w: UInt)
...
glUniformBlockBinding: extern func (program, uniformBlockIndex, uniformBlockBinding: UInt)
...
glBindSampler: extern func (unit, sampler: UInt)
...
glVertexAttribDivisor: extern func (index, divisor: UInt)
glBindTransformFeedback: extern func (target, id: UInt)
