		...
		action := func (key: String, value: Object) {
			...
			if (value instanceOf?(Cell)) {
				...
				match (cell T) {
					...
					case ColorBgr => color := cell as Cell<ColorBgr> get(); program setUniform(key, color blue as Float / 255, color green as Float / 255, color red as Float / 255)
					case ColorBgra => color := cell as Cell<ColorBgra> get(); program setUniform(key, color blue as Float / 255, color green as Float / 255, color red as Float / 255, color alpha as Float / 255)
