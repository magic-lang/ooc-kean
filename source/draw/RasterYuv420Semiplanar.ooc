...
RasterYuv420Semiplanar: class extends RasterImage {
	...
	distance: override func (other: Image, cropBox := IntBox2D new()) -> Float { (this y distance((other as This) y, cropBox) + this uv distance((other as This) uv, cropBox / 2)) / 2.0f }
	...
	draw: override func ~DrawState (drawState: DrawState) {
		...
		if (drawState inputImage != null && drawState inputImage instanceOf(This)) {
