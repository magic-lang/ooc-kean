...
FloatBox2D: cover {
	...
	createFromBottom: static func (bottomCenter: FloatPoint2D, size: FloatVector2D) -> This { This new(FloatPoint2D new(bottomCenter x - size x / 2.0f, bottomCenter y - size y), size) }
