...
QuaternionTest: class extends Fixture {
	...
	init: func () {
		...
		this add("toFloatTransform3D_1", func() {
			...
			expect(float3DTransform f, is equal to(-0.98019f) within(tolerance))
			expect(float3DTransform g, is equal to(0.19802f) within(tolerance))
			expect(float3DTransform h, is equal to(0.0f) within(tolerance))
			expect(float3DTransform i, is equal to(0.0f) within(tolerance))
			expect(float3DTransform j, is equal to(-0.19802f) within(tolerance))
			expect(float3DTransform k, is equal to(-0.9802f) within(tolerance))
		...
		this add("toFloatTransform3D_2", func() {
			...
			expect(float3DTransform d, is equal to(0.0f) within(tolerance))
			expect(float3DTransform e, is equal to(-0.7366f) within(tolerance))
			expect(float3DTransform f, is equal to(-0.32294f) within(tolerance))
			expect(float3DTransform g, is equal to(0.59424f) within(tolerance))
			expect(float3DTransform h, is equal to(0.0f) within(tolerance))
			expect(float3DTransform i, is equal to(0.48052f) within(tolerance))
			expect(float3DTransform j, is equal to(0.36841f) within(tolerance))
			expect(float3DTransform k, is equal to(0.79585f) within(tolerance))
			expect(float3DTransform l, is equal to(0.0f) within(tolerance))
			expect(float3DTransform m, is equal to(0.0f) within(tolerance))
			expect(float3DTransform n, is equal to(0.0f) within(tolerance))
			expect(float3DTransform o, is equal to(0.0f) within(tolerance))
