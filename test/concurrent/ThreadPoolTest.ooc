...
ThreadPoolTest: class extends Fixture {
	init: func {
		...
		this add("threaded_noresult", func {
			...
			expect(promise1 _state as Int, is equal to(_PromiseState Finished as Int))
			expect(promise2 _state as Int, is equal to(_PromiseState Finished as Int))
			expect(promise3 _state as Int, is equal to(_PromiseState Finished as Int))
			expect(promise4 _state as Int, is equal to(_PromiseState Cancelled as Int))
			expect(promise5 _state as Int, is equal to(_PromiseState Finished as Int))
		...
		this add("threaded_result", func {
			...
			expect(future _state as Int, is equal to(_PromiseState Finished as Int))
			expect(future2 _state as Int, is equal to(_PromiseState Finished as Int))
			expect(future3 _state as Int, is equal to(_PromiseState Finished as Int))
		...
		this add("threaded_result_cancel", func {
			...
			expect(future _state as Int, is equal to(_PromiseState Cancelled as Int))
		...
		this add("wait with timeout", func {
			...
			expect(promise _state as Int, is equal to(_PromiseState Unfinished as Int))
			expect(future wait(TimeSpan milliseconds(10)), is false)
			expect(future _state as Int, is equal to(_PromiseState Unfinished as Int))
			expect(promise wait(), is true)
			expect(future wait(), is true)
			expect(promise _state as Int, is equal to(_PromiseState Finished as Int))
			expect(future _state as Int, is equal to(_PromiseState Finished as Int))
