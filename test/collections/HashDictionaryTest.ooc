...
HashDictionaryTest: class extends Fixture {
	...
	init: func {
		...
		this add("Int", func {
			...
			expect(dictionary get("Nonexistent", 0), is equal to(0), is true)
		})
		...
		this add("Cover", func {
			...
			expect(dictionary get("Nonexistent", this defaultCover) intVal, is equal to(0), is true)
		})
		this add("Class", func {
			dictionary := HashDictionary new()
			...
			expect(dictionary get("Nonexistent", this defaultClass) intVal, is equal to(0), is true)
		})
		...
		this add("Get from primitive", func {
			...
			expect(dictionary getAsType("Second", Int, 0), is equal to(0))
			expect(dictionary getAsType("First", TestCover, defaultCover) intVal, is equal to(0))
			expect(dictionary getAsType("First", TestClass, null) == null)
			expect(dictionary getAsType("Second", TestClass, null) intVal, is equal to(1337))
		})
		this add("Get from cover", func {
			dictionary := HashDictionary new()
			testCover := TestCover new(1337, "String")
			dictionary add("First", testCover)
			expect(dictionary getAsType("First", TestCover, defaultCover) intVal, is equal to(1337))
			expect(dictionary getAsType("First", TestCover, defaultCover) stringVal == "String")
			expect(dictionary getAsType("Second", TestCover, defaultCover) intVal, is equal to(0))
			expect(dictionary getAsType("First", Int, 0), is equal to(0))
			expect(dictionary getAsType("First", TestClass, null) == null)
		})
		this add("Get from class", func {
			dictionary := HashDictionary new()
			dictionary add("First", TestClass new(1337, "String"))
			expect(dictionary getAsType("First", TestClass, null) intVal, is equal to(1337))
		...
		this add("Merge", func {
			...
			expect(dictionary3 getAsType("First", Int, 0), is equal to(1338))
			expect(dictionary3 getAsType("Second", String, "null") == "Bar")
			expect(dictionary3 getAsType("Third", TestCover, defaultCover) intVal, is equal to(43))
			expect(dictionary3 getAsType("Third", TestCover, defaultCover) stringVal == "World")
			expect(dictionary3 getAsType("Fourth", TestClass, null) intVal, is equal to(102))
			expect(dictionary3 getAsType("Fourth", TestClass, null) stringVal == "Vader")
			expect(dictionary3 getAsType("Fifth", String, "null") == "Almost")
			expect(dictionary3 getAsType("Sixth", Int, 0), is equal to(1002))
