...
IntTransform2DTest: class extends Fixture {
	...
	init: func {
		...
		this add("isIdentity", func {
			...
			expect(transform3 isIdentity, is false)
		})
		...
		this add("determinant", func {
			expect(transform0 determinant, is equal to(1))
			expect(transform1 determinant, is equal to(27))
			expect(transform2 determinant, is equal to(transform1 determinant))
			expect(transform3 determinant, is equal to(transform0 determinant))
			expect(transform4 determinant, is equal to(-200))
		})
	}
}
