...
FloatTransform2DTest: class extends Fixture {
	...
	init: func {
		...
		this add("determinant", func {
			expect(this transform0 determinant, is equal to (1.0f) within(this precision))
			expect(this transform1 determinant, is equal to (27.0f) within(this precision))
			expect(this transform2 determinant, is equal to (this transform1 determinant) within (this precision))
			expect(this transform3 determinant, is equal to (this transform0 determinant) within(this precision))
			expect(this transform4 determinant, is equal to (-200.0f) within(this precision))
			expect(this transform5 determinant, is equal to (this transform3 determinant) within(this precision))
			expect(this transform6 determinant, is equal to (0.0f) within(this precision))
		})
		this add("rotationZ", func {
			expect(this transform0 rotationZ, is equal to (0.321750554f) within(this precision))
			expect(this transform1 rotationZ, is equal to (0.519146114f) within(this precision))
			expect(this transform2 rotationZ, is equal to (0.362544237f) within(this precision))
			expect(this transform3 rotationZ, is equal to (-0.78539816f) within(this precision))
			expect(this transform4 rotationZ, is equal to (1.107148718f) within(this precision))
			expect(this transform5 rotationZ, is equal to (0.0f) within(this precision))
			expect(this transform6 rotationZ, is equal to (0.0f) within(this precision))
		})
		...
		this add("create(translation, scale, rotation) -> This", func {
			...
			expect(transform a, is equal to (2.56066017f) within (this precision))
			expect(transform b, is equal to (0.85355339f) within (this precision))
			expect(transform c, is equal to (0.0f) within (this precision))
			expect(transform d, is equal to (-0.85355339f) within (this precision))
			expect(transform e, is equal to (2.56066017f) within (this precision))
			expect(transform f, is equal to (0.0f) within (this precision))
			expect(transform g, is equal to (5.0f) within (this precision))
			expect(transform h, is equal to (7.0f) within (this precision))
			expect(transform i, is equal to (1.0f) within (this precision))
