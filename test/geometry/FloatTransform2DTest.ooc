...
FloatTransform2DTest: class extends Fixture {
	...
	init: func {
		...
		this add("set Rotation", func {
			//TODO BUT NEEDS TO UNDERSTANDS this b atan2(this a)
		})
		this add("skewX", func {
			//convert from degree to radian (degree*PI/180)
			transform := this transform0 skewX(30.0f * (3.14159265/180))
		...
		this add("skewY", func {
			//convert from degree to radian (degree*PI/180)
			transform := this transform0 skewY(30.0f * (3.14159265/180))
			expect(transform a, is equal to(3.0f) within(this precision))
