...
QuaternionTest: class extends Fixture {
	...
	init: func {
		...
		this add("sphericalLinearInterpolation_1", func {
			...
			expect(interpolated w, is equal to(0.207024594642948f) within(tolerance))
			expect(interpolated x, is equal to(0.f) within(tolerance))
			expect(interpolated y, is equal to(0.686707316993361f) within(tolerance))
			expect(interpolated z, is equal to(0.696831312442762f) within(tolerance))
		})
		this add("sphericalLinearInterpolation_2", func {
			...
			expect(interpolated w, is equal to(this quaternion10 normalized w) within(tolerance))
			expect(interpolated x, is equal to(this quaternion10 normalized x) within(tolerance))
			expect(interpolated y, is equal to(this quaternion10 normalized y) within(tolerance))
			expect(interpolated z, is equal to(this quaternion10 normalized z) within(tolerance))
		})
		this add("sphericalLinearInterpolation_3", func {
			...
			expect(interpolated w, is equal to(this quaternion8 normalized w) within(tolerance))
			expect(interpolated x, is equal to(this quaternion8 normalized x) within(tolerance))
			expect(interpolated y, is equal to(this quaternion8 normalized y) within(tolerance))
			expect(interpolated z, is equal to(this quaternion8 normalized z) within(tolerance))
		})
		this add("sphericalLinearInterpolation_4", func {
			...
			expect(interpolated w, is equal to(0.132783654949681f) within(tolerance))
			expect(interpolated x, is equal to(0.379858392040431f) within(tolerance))
			expect(interpolated y, is equal to(0.710598986213801f) within(tolerance))
			expect(interpolated z, is equal to(0.577169978227022f) within(tolerance))
		})
		this add("sphericalLinearInterpolation_5", func {
			...
			expect(interpolated w, is equal to(0.110103782308474f) within(tolerance))
			expect(interpolated x, is equal to(0.058083811709529f) within(tolerance))
			expect(interpolated y, is equal to(0.108657064266811f) within(tolerance))
			expect(interpolated z, is equal to(0.986254059724764f) within(tolerance))
		})
